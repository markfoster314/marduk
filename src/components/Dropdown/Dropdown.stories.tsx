...
export const AllSizes: Story = {
  render: () => (
    ...
    >
      <Dropdown label="Small" options={fruitOptions} size="small" placeholder="Small dropdown" />
      <Dropdown label="Medium" options={fruitOptions} size="medium" placeholder="Medium dropdown" />
      <Dropdown label="Large" options={fruitOptions} size="large" placeholder="Large dropdown" />
    </div>
  ),
};
