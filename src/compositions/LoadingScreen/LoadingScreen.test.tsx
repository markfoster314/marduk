...
describe("LoadingScreen", () => {
  describe("Rendering", () => {
    it("renders without crashing", () => {
      ...
      expect(container.querySelector(".marduk-loading-screen-container")).toBeInTheDocument();
    });
  ...
  describe("Animation Variants", () => {
    ...
    it("applies pulse animation by default", () => {
      const { container } = render(<LoadingScreen />);
      expect(container.querySelector(".marduk-loading-screen-logo--pulse")).toBeInTheDocument();
    });
  });
  ...
  describe("Dark Mode", () => {
    it("applies dark class when darkMode is true", () => {
      ...
      expect(container.querySelector(".marduk-loading-screen-container")).toHaveClass(
        "marduk-loading-screen-container--dark",
      );
    });

    it("passes darkMode to Text component", () => {
      const { container } = render(<LoadingScreen darkMode text="Loading" />);
      const textElement = container.querySelector(".marduk-loading-screen-text");
  ...
  describe("Combined Props", () => {
    it("works with custom text and animation", () => {
      const { container } = render(<LoadingScreen animation="rotate" text="Processing..." />);
      expect(screen.getByText(/Processing.../i)).toBeInTheDocument();
      expect(container.querySelector(".marduk-loading-screen-logo--rotate")).toBeInTheDocument();
    });

    it("works with custom icon, text, and animation", () => {
      const CustomIcon = <div data-testid="custom">Icon</div>;
      const { container } = render(
        <LoadingScreen icon={CustomIcon} animation="bounce" text="Loading data" />,
      );
      expect(screen.getByTestId("custom")).toBeInTheDocument();
      expect(screen.getByText(/Loading data/i)).toBeInTheDocument();
      expect(container.querySelector(".marduk-loading-screen-logo--bounce")).toBeInTheDocument();
    });

    it("works with no text and custom animation", () => {
      const { container } = render(<LoadingScreen showText={false} animation="glitch" />);
      expect(screen.queryByText(/Loading/i)).not.toBeInTheDocument();
      expect(container.querySelector(".marduk-loading-screen-logo--glitch")).toBeInTheDocument();
    });
  });
  ...
  describe("Data Attributes", () => {
    it("sets data-animation attribute", () => {
      ...
      const containerEl = container.querySelector(".marduk-loading-screen-container");
    ...
    it("sets multiple data attributes together", () => {
      const { container } = render(
        <LoadingScreen animation="bounce" showText={true} darkMode={true} textVariant="success" />,
      );
      const containerEl = container.querySelector(".marduk-loading-screen-container");
  ...
  describe("ARIA Attributes", () => {
    ...
    test.each([
      ...
      const { container } = render(<LoadingScreen showText={showText} text="Processing" />);
      const containerEl = container.querySelector(".marduk-loading-screen-container");
      if (expectedLabel) {
    ...
    it("sets aria-hidden on decorative elements", () => {
      ...
      expect(container.querySelector(".marduk-loading-screen-logo")).toHaveAttribute(
        "aria-hidden",
        "true",
      );
      expect(container.querySelector(".marduk-loading-screen-dots")).toHaveAttribute(
        "aria-hidden",
        "true",
      );
    });
  ...
  describe("Reduced Motion Accessibility", () => {
    it("maintains complete structure for accessibility", () => {
      const { container } = render(<LoadingScreen animation="bounce" showText={true} />);
      expect(container.querySelector(".marduk-loading-screen-logo--bounce")).toBeInTheDocument();
      expect(container.querySelectorAll(".marduk-loading-screen-dot")).toHaveLength(3);
    });
  });

  describe("Style Prop", () => {
    it("applies custom styles to container", () => {
      const { container } = render(<LoadingScreen style={{ opacity: "0.5" }} />);
      const containerEl = container.querySelector(".marduk-loading-screen-container");
    ...
    it("merges custom styles with component classes", () => {
      const { container } = render(<LoadingScreen darkMode style={{ padding: "20px" }} />);
      const containerEl = container.querySelector(".marduk-loading-screen-container");
